...
public class MainActivity extends Activity {
    ...
    private void initData() {
        ...
        list.add(new ChatMessage("中国人民解放军火箭军总指挥听令!", ChatMessage.Type.INCOUNT, new Date()));
    ...
    private void chat() {
        ...
        LaunchApp launchApp = new LaunchApp(send_message, getApplicationContext());
        int kind = launchApp.senToAppPackage();
        if (kind == 3) {
