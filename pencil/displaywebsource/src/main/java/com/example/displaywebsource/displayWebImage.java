...
public class displayWebImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String imgUrl = "http://www.lurrin.xyz/zltm/api/summer/dachendao/c4ca4238a0b923820dcc509a6f75849b.png";
...
//        getMenuInflater().inflate(menu, menu);
    ...
    private void showProgressBar(){
        ...
        //		displayWebCode.this.addContentView(progressBar, params);
